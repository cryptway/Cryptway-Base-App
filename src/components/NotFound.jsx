import svg from "../../images/Ethereal-bro.svg"; 
 const Receive = () => {
  return (
    ...
    <h1 className="text-white font-poppins font-black text-5xl tracking-wide">Not Found</h1>
   <div className="mt-10 w-full flex justify-center">
      <div className="relative md:max-w-[700px] md:min-w-[500px] min-w-full max-w-full gradient-border p-[2px] rounded-3xl">
        ...
        <p className="text-gray-400	 font-poppins font-medium mt-3 text-base">This page Not Exist Click on Logo to go home</p>
  </div>
 </div>
 </div>

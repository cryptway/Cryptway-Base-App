 ...
 return (
   ...
   <div className="mt-10 w-full flex justify-center">
      <div className="relative md:max-w-[700px] md:min-w-[500px] min-w-full max-w-full gradient-border p-[2px] rounded-3xl">
       ...
       <h1 className="text-white font-poppins font-black text-5xl tracking-wide">Thank You</h1>
       <img src={thank} alt="" />
        <p className="text-gray-400	 font-poppins font-medium mt-3 text-base">Thank you for funding our Faucet</p>
  </div>
 </div>
        </div>
